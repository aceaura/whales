...
commands = [
    ...
    "cd /mysql-dump-run/ && /spark/bin/spark-submit --packages=mysql:mysql-connector-java:5.1.48 mysql-5-spark-dump-runner.py '{}' '{}' {} '{}'".format(jdbc_url, table_name, repartition_count, output_dir)
]
